...
PUMA_PID_FILE=/tmp/markerdb.puma.pid
PUMA_SOCKET=/tmp/markerdb.puma.sock

# PUMA_CONFIG_FILE=config/puma.rb
# PUMA_PID_FILE=/apps/markerdb/project/shared/tmp/foodb.puma.pid
# PUMA_SOCKET=/apps/markerdb/project/shared/tmp/sockets/puma.sock
